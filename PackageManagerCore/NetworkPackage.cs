    ...
    public class NetworkPackage
    {
        ...
        private List<byte> GetBytesWithChecksum(List<NetworkPackageValue> packageValues)
        {
            ...
            foreach (var packageValue in packageValues)
            {
                ...
                {
                    //if(packageValue.ByteArrayValue.Count() == 0)
                    //{
                    //    SetByteValues(packageValue, packageValue.Value, packageValue.Type);
                    //}
        ...
        private void SetByteValues(NetworkPackageValue paramValue, dynamic value, Type type)
        {
            dynamic converter = GetConverter(type);
